...
Salinas_CO <-
  epa_aqs_loadAnnual(42101, 2016, archiveBaseDir = "~/Data/monitoring") %>%
...
CA_Ozone <-
  epa_aqs_loadAnnual(44201, 2016, archiveBaseDir = "~/Data/monitoring") %>%
  monitor_filterDate(20160614, 20160623, timezone = "America/Los_Angeles") %>%
  monitor_filterMeta(stateCode == "CA")
...
CA_PM10 <-
  epa_aqs_loadAnnual(81102, 2016, archiveBaseDir = "~/Data/monitoring") %>%
  monitor_filterDate(20160614, 20160623, timezone = "America/Los_Angeles") %>%
  monitor_filterMeta(stateCode == "CA")
