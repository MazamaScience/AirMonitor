...
names begin with `monitor_`,  expect objects of class `mts_monitor` as their first 
...
_mts_monitor_ object, typically called `monitor`. Each `monitor` is just an R 
...
TwispID <- "40ffdacb421a5ee6_840530470010"
WinthropID <- "450d08fb5a3e4ea0_530470009"
...
manipulate of the data tibble from a `mts_monitor` with `monitor_mutate()`.
...
independ of the `mts_monitor` data model. Here we look for correlations among
...
_Best of luck exploring and understanding PM 2.air quality data!_
