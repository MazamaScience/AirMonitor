...
single monitor and take a look at a timeseries plot. Day-night shading and AQI
...
We can use the same `monitor_timeseriesPlot()` to display the hourly data for 
all the monitors in the Sacramennto area.
