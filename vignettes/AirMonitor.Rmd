...
```{r Sacramento_3}
#| fig.alt: >
#|   Tmeseries plot of hourly PM2.5 concentration in Sacramento during the
#|   2018 Camp Fire. Several days in mid-November had hours with VERY UNHEALTHY or
...
```{r Sacramento_5}
#| fig.alt: >
#|   Tmeseries plot of hourly PM2.5 concentration in the greater Sacramento area during the
#|   2018 Camp Fire. Several days in mid-November had hours with VERY UNHEALTHY or
#|   HAZARDOUS air quality.
Sacramento_area %>%
  monitor_timeseriesPlot(
...
```{r Sacramento_7}
#| fig.alt: >
#|   Barplot of daily averaged PM2.5 concentration in the greater Sacramento area during the
#|   2018 Camp Fire. Several days in mid-November had daily average values in
#|   the UNHEALTHY or VERY UNHEALTHY categories.
# 1) start with Sacramento_area
Sacramento_area %>%
