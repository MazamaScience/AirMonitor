...
# NOTE:  The next three functions are modified from the maptools source code.
# NOTE:    https://cloud.r-project.org/src/contrib/maptools_1.1-2.tar.gz
...
# NOTE:  Functions below here were copied verbatim from the maptools source code.
# NOTE:    https://cloud.r-project.org/src/contrib/maptools_1.1-2.tar.gz
