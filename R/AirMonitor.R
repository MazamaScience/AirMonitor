...
US_AQI <- list(
  ...
  breaks_PM2.5 = c(-Inf, 12, 35.4, 55.4, 150.4, 250.4, Inf),     # Using PM2.5_24hr
  breaks_PM2.5_2024 = c(-Inf, 9, 35.4, 55.4, 125.4, 225.4, Inf), # https://www.epa.gov/system/files/documents/2024-02/pm-naaqs-air-quality-index-fact-sheet.pdf
