...
#'
#' For daily updates covering the most recent 45 days, use \code{clarity_loadDaily()}.
#'
#' @seealso \code{\link{clarity_loadDaily}}
#'
#' @examples
#' \dontrun{
#' library(AirMonitor)
...
#'
#' # Clarity monitors during the Snake River Complex Fire
#' clarity_loadAnnual(2021) \%>\%
...
#'     xpd = NA,
#'     addAQI = TRUE,
#'     main = "Clarity monitors during Snake River Complex Fire"
#'   )
#'
#' }, silent = FALSE)
#' }
